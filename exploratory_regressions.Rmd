...
presentation_results_39 <- compile_results(regions_to_combine, type = "pres-locked", sub = "IR39", path = path(here(), "results", "IR39", "insula"))
...
presentation_results_39 %>%
  ...
  mutate(bin_sig = if_else((p < .05 & perm_p < 0.01), 1, 0)) %>%

...
# necessary paths #
file_path_to_electrode_names <- path(here(), "munge", "IR35_electrodes_choice_locked.csv")
file_path_to_hg_data <- path(here(), "munge", "IR35_hg_munge_choice_locked.csv")
...
write.csv(hg_behave, path(here(), "munge", "hg_behave_choice_locked.csv"))

...
write.csv(hg_behave, path(here(), "munge", "IR35", "hg_behave_presentation_locked_extended.csv"))
...
active_elec_plots(presentation_results, "self_var_payoff", "Self Options Results")

active_elec_plots(presentation_results, "other_var_payoff", "Other Options Results")

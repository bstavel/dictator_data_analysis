...
presentation_results_39 <- compile_results(regions_to_combine, type = "pres-locked-100", sub = "IR39", path = path(here(), "results", "IR39", "insula"))
...
# combine different csvs #
regions_to_combine <- c("Insula")
presentation_results_35 <- compile_results(regions_to_combine, type = "pres-locked", sub = "IR35", path = path(here(), "results", "IR35", "insula"))
...
# combine different csvs #
regions_to_combine <- c("Insula")
choice_results_39 <- compile_results(regions_to_combine, type = "choice-locked", sub = "IR39", path = path(here(), "results", "IR39", "insula"))
...
# read back in the results #
region_name <- "All"
adv_choice_results_for_plots_39 <- read.csv(fs::path(here(), "results", "IR39", paste0(region_name, "choice-locked_insula_anova_results_advantageous.csv")))
dis_choice_results_for_plots_39 <- read.csv(fs::path(here(), "results", "IR39", paste0(region_name, "choice-locked_anova_results_disadvantageous.csv")))
...
# combine different csvs #
regions_to_combine <- c("Insula")
choice_results_35 <- compile_results(regions_to_combine, type = "choice-locked", sub = "IR35", path = path(here(), "results", "IR35", "insula"))
...
active_elec_plots(presentation_results_35, "ineq_advent", "Adv Ineq Results: IR35")
active_elec_plots(presentation_results_39, "ineq_advent", "Adv Ineq Results: IR39")
active_elec_plots(presentation_results_35, "ineq_disadvent", "Dis Ineq Results: IR35")
active_elec_plots(presentation_results_39, "ineq_disadvent", "Dis Ineq Results: IR39")
active_elec_plots(presentation_results_35, "self_payoff", "Self Payoff Results: IR35")
active_elec_plots(presentation_results_39, "self_payoff", "Self Payoff Results: IR39")
active_elec_plots(presentation_results_35, "self_foregone", "Self Forgeone Results: IR35")
active_elec_plots(presentation_results_39, "self_foregone", "Self Forgeone Results: IR39")
active_elec_plots(presentation_results_35, "other_payoff", "Other Payoff Results: IR35")
active_elec_plots(presentation_results_39, "other_payoff", "Other Payoff Results: IR39")
active_elec_plots(presentation_results_35, "other_foregone", "Other Forgeone Results: IR35")
active_elec_plots(presentation_results_39, "other_foregone", "Other Forgeone Results: IR39")
active_elec_plots(presentation_results_35, "self_var_payoff", "Self Options Results: IR35")
active_elec_plots(presentation_results_39, "self_var_payoff", "Self Options Results: IR39")
active_elec_plots(presentation_results_35, "other_var_payoff", "Other Options Results: IR35")
active_elec_plots(presentation_results_39, "other_var_payoff", "Other Options Results: IR39")


getPalette = colorRampPalette(brewer.pal(8, "Set1"))
presentation_results_39 %>%
  filter(!predictor %in% c("ineq_advent", "ineq_disadvent")) %>%
  mutate(bin_sig = if_else((p < .05 & perm_p < 0.0007), 1, 0)) %>%
  ...
  theme(axis.text.x = element_blank(), 
    ...
    labs(y = "percent of regressors", x = "Bins", fill = "Region", color = "Region") +
  facet_wrap(~electrode) +
  ggtitle("IR39")


presentation_results_35 %>%
  filter(!predictor %in% c("ineq_advent", "ineq_disadvent")) %>%
  mutate(bin_sig = if_else((p < .05 & perm_p < 0.0007), 1, 0)) %>%
  group_by(bin, electrode) %>%
  mutate(bin_sum = sum(bin_sig)/6) %>%
...
choice_results_39 %>%
  filter(!predictor %in% c("ineq_advent", "ineq_disadvent")) %>%
  mutate(bin_sig = if_else((p < .05 & perm_p < 0.0007), 1, 0)) %>%
  group_by(bin, predictor) %>%
  ggplot(., aes(x= bin, y = bin_sig)) + 
  geom_col(alpha = .5) + 
  theme(axis.text.x = element_blank(), 
        axis.ticks.x = element_blank(), 
        panel.background = element_rect(fill = "white")) + 
    scale_fill_manual(values = c("grey", getPalette(8))) +
    scale_color_manual(values = c("grey", getPalette(8))) +
    labs(y = "num of electrode", x = "Bins", fill = "Region", color = "Region") +

...
```{r IR35-get-active-elecs-presentation}
...
for(elec in unique(active_only_data_35$electrodes)) {
  ...
  plots_power_envelope_by_trial_type(hg_data, 
                                     behave_data_11, 
                                     active_only_data_35, 
                                     elec,
                                     choice = F,
...
```{r table-of-active-electrodes}

active_only_data_57$sub <- "IR57"
active_only_data_35$sub <- "IR35"
active_only_data_10$sub <- "IR19"

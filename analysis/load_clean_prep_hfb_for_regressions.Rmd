...
hg_behave <- hg_behave %>% filter(!is.na(RT))
# save it #
write.csv(hg_behave, path(here(), "munge", "IR39", "hg_behave_presentation_locked_extended_150_insula.csv"))
...
write.csv(hg_behave, path(here(), "munge", "IR16", "hg_behave_presentation_locked_extended_150_insula.csv"))
...
hg_behave <- hg_behave %>% filter(!is.na(RT))
# save it #
write.csv(hg_behave, path(here(), "munge", "IR35", "hg_behave_choice_locked_cut_fixation_150_insula_norm_deviance.csv"))
...
hg_behave <- hg_behave %>% filter(!is.na(RT))
# save it #
write.csv(hg_behave, path(here(), "munge", "IR16", "hg_behave_choice_locked_cut_fixation_150_insula.csv"))

...
active_data <- read_csv(path(here(),
                             "results", "active_elecs", "all_theta_electrode_tests.csv"))

# read in active_only data #

active_only_data <- read_csv(path(here(),
                                  "results", "active_elecs", "active_theta_electrode_tests.csv"))
...
hg_data <- read_csv(path(here(),
                         "results", "active_elecs", "combined_theta_behave_data.csv"))
hg_choice_data <- read_csv( path(here(),
                                 "results",
                                 "active_elecs", "combined_theta_behave_choice_data.csv"))
...
for(roi in rois_of_interest){
  ...
  pres_plot <-  labeled_hg_data_prepped %>%
      ...
      labs(y = "mean theta", fill = "Trial Type", color = "Trial Type", x = "Time") +

...
# pres #
run_permuted_multiple_regressions_par(brain_behave_data, electrodes = all_electrodes, regressor = c("ineq_disadvent", "other_var_payoff"), nBins, region_name =  "All", niter, sub = "IR35", tag = "multiple-theta-choice-locked-hilbertRS")
run_permuted_multiple_regressions_par(brain_behave_data, electrodes = all_electrodes, regressor = c("other_var_payoff", "ineq_disadvent"), nBins, region_name =  "All", niter, sub = "IR35", tag = "multiple-theta-choice-locked-hilbertRS")
# choice #
run_permuted_multiple_regressions_par(brain_behave_data, electrodes = all_electrodes, regressor = c("ineq_foregone", "other_foregone"), nBins, region_name =  "All", niter, sub = "IR35", tag = "multiple-theta-choice-locked-hilbertRS")
run_permuted_multiple_regressions_par(brain_behave_data, electrodes = all_electrodes, regressor = c("other_foregone", "ineq_foregone"), nBins, region_name =  "All", niter, sub = "IR35", tag = "multiple-theta-choice-locked-hilbertRS")
# # adv ineq #

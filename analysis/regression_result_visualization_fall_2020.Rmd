...
## delta ##
beta_plots_all_subjects(left_delta_presentation_cleaned_results_57, "IR57 ~ Left ~ delta ~ Pres", 10, sig_thresh = 0.01)
beta_plots_all_subjects(right_delta_presentation_cleaned_results_57, "IR57 ~ Right ~ delta ~ Pres", 10, sig_thresh = 0.01)
...
## alpha ##
beta_plots_all_subjects(left_alpha_presentation_cleaned_results_57, "IR57 ~ Left ~ alpha ~ Pres", 10, sig_thresh = 0.01)
beta_plots_all_subjects(right_alpha_presentation_cleaned_results_57, "IR57 ~ Right ~ alpha ~ Pres", 10, sig_thresh = 0.01)
...
## beta ##
beta_plots_all_subjects(left_beta_presentation_cleaned_results_57, "IR57 ~ Left ~ beta ~ Pres", 10, sig_thresh = 0.01)
beta_plots_all_subjects(right_beta_presentation_cleaned_results_57, "IR57 ~ Right ~ beta ~ Pres", 10, sig_thresh = 0.01)
...
## gamma ##
beta_plots_all_subjects(left_gamma_presentation_cleaned_results_57, "IR57 ~ Left ~ gamma ~ Pres", 10, sig_thresh = 0.01)
beta_plots_all_subjects(right_gamma_presentation_cleaned_results_57, "IR57 ~ Right ~ gamma ~ Pres", 10, sig_thresh = 0.01)
...
alphaa_choice_cleaned_results_9 <- merge_with_elec_info(alpha_choice_results_9, localizations_9)
...
alphaa_choice_cleaned_results_10 <- merge_with_elec_info(alpha_choice_results_10, localizations_10)
...
alphaa_choice_cleaned_results_26 <- merge_with_elec_info(alpha_choice_results_26, localizations_26)
...
alphaa_choice_cleaned_results_16 <- merge_with_elec_info(alpha_choice_results_16, localizations_16)
...
beta_plots_all_subjects_choice(left_delta_choice_cleaned_results_57, "IR57 ~ Left ~ delta ~ Choice", 10, sig_thresh = 0.01)
beta_plots_all_subjects_choice(right_delta_choice_cleaned_results_57, "IR57 ~ Right ~ delta ~ Choice", 10, sig_thresh = 0.01)
...
beta_plots_all_subjects_choice(left_alpha_choice_cleaned_results_57, "IR57 ~ Left ~ alpha ~ Choice", 10, sig_thresh = 0.01)
beta_plots_all_subjects_choice(right_alpha_choice_cleaned_results_57, "IR57 ~ Right ~ alpha ~ Choice", 10, sig_thresh = 0.01)
...
beta_plots_all_subjects_choice(left_beta_choice_cleaned_results_57, "IR57 ~ Left ~ beta ~ Choice", 10, sig_thresh = 0.01)
beta_plots_all_subjects_choice(right_beta_choice_cleaned_results_57, "IR57 ~ Right ~ beta ~ Choice", 10, sig_thresh = 0.01)
...
beta_plots_all_subjects_choice(left_gamma_choice_cleaned_results_57, "IR57 ~ Left ~ gamma ~ Choice", 10, sig_thresh = 0.01)
beta_plots_all_subjects_choice(right_gamma_choice_cleaned_results_57, "IR57 ~ Right ~ gamma ~ Choice", 10, sig_thresh = 0.01)

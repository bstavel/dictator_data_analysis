...
delta_presentation_results_57 <- compile_results(regions = regions_to_combine,
                                           type = "delta-pres-locked-hilbertRS",
                                           sub = "IR57",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR57", "post_eda"),
...
theta_presentation_results_57 <- compile_results(regions = regions_to_combine, 
                                           ...
                                           path = path(here(), "results", "IR57", "post_eda"), 
                                           absBeta = abs_beta_val)
alpha_presentation_results_57 <- compile_results(regions = regions_to_combine,
                                           type = "alpha-pres-locked-hilbertRS",
                                           sub = "IR57",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR57", "post_eda"),
...
beta_presentation_results_57 <- compile_results(regions = regions_to_combine,
                                           type = "beta-pres-locked-hilbertRS",
                                           sub = "IR57",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR57", "post_eda"),
...
gamma_presentation_results_57 <- compile_results(regions = regions_to_combine,
                                           type = "gamma-pres-locked-hilbertRS",
                                           sub = "IR57",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR57", "post_eda"),
...
# combine different csvs #
hfa_presentation_results_cp34 <- compile_results(regions = regions_to_combine, 
                                           type = "hfa-pres-locked-hilbertRS", 
                                           sub = "CP34", 
                                           spec_vars = spec_vars, 
                                           path = path(here(), "results", "CP34", "post_eda"), 
                                           absBeta = abs_beta_val)

delta_presentation_results_cp34 <- compile_results(regions = regions_to_combine,
                                           type = "delta-pres-locked-hilbertRS",
                                           sub = "CP34",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "CP34", "post_eda"),
...
theta_presentation_results_cp34 <- compile_results(regions = regions_to_combine, 
                                           type = "theta-pres-locked-hilbertRS", 
                                           sub = "CP34", 
                                           spec_vars = spec_vars, 
                                           path = path(here(), "results", "CP34", "post_eda"), 
                                           absBeta = abs_beta_val)
alpha_presentation_results_cp34 <- compile_results(regions = regions_to_combine,
                                           type = "alpha-pres-locked-hilbertRS",
                                           sub = "CP34",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "CP34", "post_eda"),
...
beta_presentation_results_cp34 <- compile_results(regions = regions_to_combine,
                                           type = "beta-pres-locked-hilbertRS",
                                           sub = "CP34",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "CP34", "post_eda"),
...
gamma_presentation_results_cp34 <- compile_results(regions = regions_to_combine,
                                           type = "gamma-pres-locked-hilbertRS",
                                           sub = "CP34",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "CP34", "post_eda"),
...
# combine different csvs #
delta_choice_results_cp34 <- compile_results(regions = regions_to_combine,
                                           type = "delta-choice-locked-hilbertRS",
                                           sub = "CP34",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "CP34", "post_eda"),
...
theta_choice_results_cp34 <- compile_results(regions = regions_to_combine, 
                                           type = "theta-choice-locked-hilbertRS", 
                                           sub = "CP34", 
                                           spec_vars = spec_vars, 
                                           path = path(here(), "results", "CP34", "post_eda"), 
                                           absBeta = abs_beta_val)
alpha_choice_results_cp34 <- compile_results(regions = regions_to_combine,
                                           type = "alpha-choice-locked-hilbertRS",
                                           sub = "CP34",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "CP34", "post_eda"),
...
beta_choice_results_cp34 <- compile_results(regions = regions_to_combine,
                                           type = "beta-choice-locked-hilbertRS",
                                           sub = "CP34",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "CP34", "post_eda"),
...
gamma_choice_results_cp34 <- compile_results(regions = regions_to_combine,
                                           type = "gamma-choice-locked-hilbertRS",
                                           sub = "CP34",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "CP34", "post_eda"),
...
hfa_choice_results_cp34 <- compile_results(regions = regions_to_combine, 
                                           type = "hfa-choice-locked-hilbertRS", 
                                           sub = "CP34", 
                                           spec_vars = spec_vars, 
                                           path = path(here(), "results", "CP34", "post_eda"), 
...
hfa_presentation_cleaned_results_35 <- merge_with_elec_info(hfa_presentation_results_35,
                                                            localizations_35)
# IR57 #
delta_presentation_cleaned_results_57 <- merge_with_elec_info(delta_presentation_results_57,
                                                            localizations_57)
theta_presentation_cleaned_results_57 <- merge_with_elec_info(theta_presentation_results_57,
                                                              localizations_57)
beta_presentation_cleaned_results_57 <- merge_with_elec_info(beta_presentation_results_57,
                                                              localizations_57)
alpha_presentation_cleaned_results_57 <- merge_with_elec_info(alpha_presentation_results_57,
                                                            localizations_57)
gamma_presentation_cleaned_results_57 <- merge_with_elec_info(gamma_presentation_results_57,
                                                            localizations_57)
...
# CP34 #
delta_presentation_cleaned_results_cp34 <- merge_with_elec_info(delta_presentation_results_cp34,
                                                            localizations_cp34)
theta_presentation_cleaned_results_cp34 <- merge_with_elec_info(theta_presentation_results_cp34,
                                                              localizations_cp34)
beta_presentation_cleaned_results_cp34 <- merge_with_elec_info(beta_presentation_results_cp34,
                                                              localizations_cp34)
alpha_presentation_cleaned_results_cp34 <- merge_with_elec_info(alpha_presentation_results_cp34,
                                                            localizations_cp34)
gamma_presentation_cleaned_results_cp34 <- merge_with_elec_info(gamma_presentation_results_cp34,
                                                            localizations_cp34)
hfa_presentation_cleaned_results_cp34 <- merge_with_elec_info(hfa_presentation_results_cp34,
                                                            localizations_cp34)
```
...
# IR57 #
left_delta_presentation_cleaned_results_57 <- delta_presentation_cleaned_results_57 %>% filter(grepl("^L", electrode))
right_delta_presentation_cleaned_results_57 <- delta_presentation_cleaned_results_57 %>% filter(grepl("^R", electrode))
...
left_alpha_presentation_cleaned_results_57 <- alpha_presentation_cleaned_results_57 %>% filter(grepl("^L", electrode))
right_alpha_presentation_cleaned_results_57 <- alpha_presentation_cleaned_results_57 %>% filter(grepl("^R", electrode))

left_beta_presentation_cleaned_results_57 <- beta_presentation_cleaned_results_57 %>% filter(grepl("^L", electrode))
right_beta_presentation_cleaned_results_57 <- beta_presentation_cleaned_results_57 %>% filter(grepl("^R", electrode))

left_gamma_presentation_cleaned_results_57 <- gamma_presentation_cleaned_results_57 %>% filter(grepl("^L", electrode))
right_gamma_presentation_cleaned_results_57 <- gamma_presentation_cleaned_results_57 %>% filter(grepl("^R", electrode))
...
# CP34 #
left_delta_presentation_cleaned_results_cp34 <- delta_presentation_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_delta_presentation_cleaned_results_cp34 <- delta_presentation_cleaned_results_cp34 %>% filter(grepl("^R", electrode))

left_theta_presentation_cleaned_results_cp34 <- theta_presentation_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_theta_presentation_cleaned_results_cp34 <- theta_presentation_cleaned_results_cp34 %>% filter(grepl("^R", electrode))

left_alpha_presentation_cleaned_results_cp34 <- alpha_presentation_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_alpha_presentation_cleaned_results_cp34 <- alpha_presentation_cleaned_results_cp34 %>% filter(grepl("^R", electrode))

left_beta_presentation_cleaned_results_cp34 <- beta_presentation_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_beta_presentation_cleaned_results_cp34 <- beta_presentation_cleaned_results_cp34 %>% filter(grepl("^R", electrode))

left_gamma_presentation_cleaned_results_cp34 <- gamma_presentation_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_gamma_presentation_cleaned_results_cp34 <- gamma_presentation_cleaned_results_cp34 %>% filter(grepl("^R", electrode))

left_hfa_presentation_cleaned_results_cp34 <- hfa_presentation_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_hfa_presentation_cleaned_results_cp34 <- hfa_presentation_cleaned_results_cp34 %>% filter(grepl("^R", electrode))
...
# CP34 #
delta_choice_cleaned_results_cp34 <- merge_with_elec_info(delta_choice_results_cp34, localizations_cp34)
theta_choice_cleaned_results_cp34 <- merge_with_elec_info(theta_choice_results_cp34, localizations_cp34)
alpha_choice_cleaned_results_cp34 <- merge_with_elec_info(alpha_choice_results_cp34, localizations_cp34)
beta_choice_cleaned_results_cp34 <- merge_with_elec_info(beta_choice_results_cp34, localizations_cp34)
gamma_choice_cleaned_results_cp34 <- merge_with_elec_info(gamma_choice_results_cp34, localizations_cp34)
hfa_choice_cleaned_results_cp34 <- merge_with_elec_info(hfa_choice_results_cp34, localizations_cp34)
...
left_delta_choice_cleaned_results_cp34 <- delta_choice_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_delta_choice_cleaned_results_cp34 <- delta_choice_cleaned_results_cp34 %>% filter(grepl("^R", electrode))
...
left_theta_choice_cleaned_results_cp34 <- theta_choice_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_theta_choice_cleaned_results_cp34 <- theta_choice_cleaned_results_cp34 %>% filter(grepl("^R", electrode))
...
left_alpha_choice_cleaned_results_cp34 <- alpha_choice_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_alpha_choice_cleaned_results_cp34 <- alpha_choice_cleaned_results_cp34 %>% filter(grepl("^R", electrode))
...
left_beta_choice_cleaned_results_cp34 <- beta_choice_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_beta_choice_cleaned_results_cp34 <- beta_choice_cleaned_results_cp34 %>% filter(grepl("^R", electrode))
...
left_gamma_choice_cleaned_results_cp34 <- gamma_choice_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_gamma_choice_cleaned_results_cp34 <- gamma_choice_cleaned_results_cp34 %>% filter(grepl("^R", electrode))
...
left_hfa_choice_cleaned_results_cp34 <- hfa_choice_cleaned_results_cp34 %>% filter(grepl("^L", electrode))
right_hfa_choice_cleaned_results_cp34 <- hfa_choice_cleaned_results_cp34 %>% filter(grepl("^R", electrode))
...
all_choice_results <- rbind(delta_choice_cleaned_results_cp34 %>% mutate(freq = "delta")   %>% mutate(sub = "CP34"),
                     theta_choice_cleaned_results_cp34 %>% mutate(freq = "theta") %>% mutate(sub = "CP34"),
                     alpha_choice_cleaned_results_cp34 %>% mutate(freq = "alpha") %>% mutate(sub = "CP34"),
                     beta_choice_cleaned_results_cp34 %>% mutate(freq = "beta") %>% mutate(sub = "CP34"),
                     gamma_choice_cleaned_results_cp34 %>% mutate(freq = "gamma") %>% mutate(sub = "CP34"),
                     hfa_choice_cleaned_results_cp34 %>% mutate(freq = "hfa") %>% mutate(sub = "CP34"),
                     delta_choice_cleaned_results_57 %>% mutate(freq = "delta")   %>% mutate(sub = "IR57"),
                     theta_choice_cleaned_results_57 %>% mutate(freq = "theta") %>% mutate(sub = "IR57"),
                     alpha_choice_cleaned_results_57 %>% mutate(freq = "alpha") %>% mutate(sub = "IR57"),
                     beta_choice_cleaned_results_57 %>% mutate(freq = "beta") %>% mutate(sub = "IR57"),
                     gamma_choice_cleaned_results_57 %>% mutate(freq = "gamma") %>% mutate(sub = "IR57"),
                     hfa_choice_cleaned_results_57 %>% mutate(freq = "hfa") %>% mutate(sub = "IR57"),
                     delta_choice_cleaned_results_35 %>% mutate(freq = "delta")   %>% mutate(sub = "IR35"),
...
all_presentation_results <- rbind(delta_presentation_cleaned_results_cp34 %>% mutate(freq = "delta") %>% mutate(sub = "CP34"),
                     theta_presentation_cleaned_results_cp34 %>% mutate(freq = "theta") %>% mutate(sub = "CP34"),
                     alpha_presentation_cleaned_results_cp34 %>% mutate(freq = "alpha") %>% mutate(sub = "CP34"),
                     beta_presentation_cleaned_results_cp34 %>% mutate(freq = "beta") %>% mutate(sub = "CP34"),
                     gamma_presentation_cleaned_results_cp34 %>% mutate(freq = "gamma") %>% mutate(sub = "CP34"),
                     hfa_presentation_cleaned_results_cp34 %>% mutate(freq = "hfa") %>% mutate(sub = "CP34"),
                     delta_presentation_cleaned_results_57 %>% mutate(freq = "delta")   %>% mutate(sub = "IR57"),
                     theta_presentation_cleaned_results_57 %>% mutate(freq = "theta") %>% mutate(sub = "IR57"),
                     alpha_presentation_cleaned_results_57 %>% mutate(freq = "alpha") %>% mutate(sub = "IR57"),
                     beta_presentation_cleaned_results_57 %>% mutate(freq = "beta") %>% mutate(sub = "IR57"),
                     gamma_presentation_cleaned_results_57 %>% mutate(freq = "gamma") %>% mutate(sub = "IR57"),
                     hfa_presentation_cleaned_results_57 %>% mutate(freq = "hfa") %>% mutate(sub = "IR57"),
                     delta_presentation_cleaned_results_35 %>% mutate(freq = "delta") %>% mutate(sub = "IR35"),
...
# write csv #
write_csv(all_results, path(here(), "results", "compiled_regressions", "all_results_12-21-20.csv"))
...
hold <- all_results %>%
  ...
  distinct() %>%
  group_by(freq, epoch, sub, region) %>%
  mutate(total_elecs = n()) %>%
  filter(perm_p < .01) %>%
  group_by(freq, epoch, region, sub, total_elecs) %>%
  summarise(n = n()) %>%
  mutate(percent_active = n/total_elecs) %>%
  select(total_elecs) %>%

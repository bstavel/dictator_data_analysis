---
title: "HG ~ Find Active Electrodes"
...
write_csv(active_data, 
          path(here(), "results", "active_elecs", "all_hfa_electrode_tests.csv"))
write_csv(active_only_data, 
          path(here(), "results", "active_elecs", "active_hfa_electrode_tests.csv"))
...
write_csv(hg_data, path(here(), "results", "active_elecs", "combined_hfa_behave_data.csv"))
...
write_csv(hg_choice_data, 
          path(here(), "results", "active_elecs", "combined_hfa_behave_choice_data.csv"))
```

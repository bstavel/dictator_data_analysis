...
spec_vars <- c("self_diff", "other_diff")
abs_beta_val <- F
...
presentation_results_39 <- compile_results(regions_to_combine, type = "pres-locked-100", sub = "IR39", path = path(here(), "results", "IR39", "insula"), absBeta = abs_beta_val)
...
# combine different csvs #
regions_to_combine <- c("Insula")
presentation_results_35 <- compile_results(regions_to_combine, type = "pres-locked", sub = "IR35", path = path(here(), "results", "IR35", "insula"), absBeta = abs_beta_val)
...
dis_pres_results_for_plots_35 <- read.csv(fs::path(here(), "results", "IR35", paste0(region_name, "_pres-locked_insula_anova_results_", reg_name_one, ".csv")))

## IR19 ##

# combine different csvs #
regions_to_combine <- c("Insula")
presentation_results_19 <- compile_results(regions_to_combine, type = "pres-locked", sub = "IR19", spec_vars, path = path(here(), "results", "IR19", "insula"), absBeta = abs_beta_val)
...
dis_pres_results_for_plots_19 <- read.csv(fs::path(here(), "results", "IR19", paste0(region_name, "_pres-locked_insula_anova_results_", reg_name_one, ".csv")))

...
theta_presentation_results_19 <- compile_results(regions = regions_to_combine, 
                                           type = "theta-pres-locked-wavelets", 
                                           sub = "IR19", 
                                           spec_vars = spec_vars, 
                                           path = path(here(), "results", "IR19", "hilbert", "savio"), 
                                           absBeta = abs_beta_val)
...
l_19 <- presentation_results_19 %>% filter(grepl("^L", electrode))
r_19 <- presentation_results_19 %>% filter(grepl("^R", electrode))

combined_active_plots(l_19, "IR19 ~ Presentation ~ Left", 3, sig_thresh = 0.005)
combined_active_plots(r_19, "IR19 ~ Presentation ~ Right", 3, sig_thresh = 0.005)

combined_active_plots(presentation_results_19, "IR19 ~ Presentation ~ theta", 3, sig_thresh = 0.005)

hfa_presentation_results_19 <- hfa_presentation_results_19 %>%
  filter(predictor %in% c("self_foregone", "other_foregone", "self_payoff", "other_payoff"))

combined_active_plots(hfa_presentation_results_19, "IR19 ~ Presentation ~ hfa", 3, sig_thresh = 0.005)

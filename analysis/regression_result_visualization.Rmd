...
plot_39_01 <- combined_active_plots(presentation_results_39, "IR39 ~ Presentation", 2, sig_thresh = 0.01)
plot_35_01 <- combined_active_plots(presentation_results_35, "IR35 ~ Presentation", 2, sig_thresh = 0.01)
plot_19_01 <- combined_active_plots(presentation_results_19, "IR19 ~ Presentation", 3, sig_thresh = 0.01)

ggsave(filename = paste0(path(here(), './figures/plot_39_01.png')),
     device = "png",
     width = 20,
     height = 10,
     units = "cm",
     dpi = 200,
     plot =  print(plot(plot_39_01)) )

ggsave(filename = paste0(path(here(), './figures/plot_35_01.png')),
     device = "png",
     width = 20,
     height = 10,
     units = "cm",
     dpi = 200,
     plot =  print(plot(plot_35_01)) )

ggsave(filename = paste0(path(here(), './figures/plot_19_01.png')),
     device = "png",
     width = 20,
     height = 10,
     units = "cm",
     dpi = 200,
     plot =  print(plot(plot_19_01)) )

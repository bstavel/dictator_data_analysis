...
plot_39_05 <- combined_active_plots(presentation_results_39, "IR39 ~ Presentation", 2, sig_thresh = 0.05)
plot_35_05 <- combined_active_plots(presentation_results_35, "IR35 ~ Presentation", 2, sig_thresh = 0.05)
plot_19_05 <- combined_active_plots(presentation_results_19, "IR19 ~ Presentation", 3, sig_thresh = 0.05)

ggsave(filename = paste0(path(here(), './figures/plot_39_05.png')),
     device = "png",
     width = 20,
     height = 10,
     units = "cm",

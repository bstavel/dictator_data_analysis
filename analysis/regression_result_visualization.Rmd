...
# By region #
beta_plots_all_subjects_choice(theta_choice_cleaned_results_19, "IR19 ~ STS ~ theta ~ Choice", 8, sig_thresh = 0.01, vars = c("self_payoff", "other_payoff", "self_foregone", "other_foregone", "ineq_advent", "ineq_disadvent"), regions = c("STS", "sts"))
beta_plots_all_subjects_choice(theta_choice_cleaned_results_35, "IR35 ~ STS ~ theta ~ Choice", 8, sig_thresh = 0.01, vars = c("self_payoff", "other_payoff", "self_foregone", "other_foregone", "ineq_advent", "ineq_disadvent"), regions = c("STS", "sts"))
beta_plots_all_subjects_choice(theta_choice_cleaned_results_57, "IR57 ~ STS ~ theta ~ Choice", 8, sig_thresh = 0.01, vars = c("self_payoff", "other_payoff", "self_foregone", "other_foregone", "ineq_advent", "ineq_disadvent"), regions = c("STS", "sts"))
...
# By region #
beta_plots_all_subjects_choice(beta_choice_cleaned_results_19, "IR19 ~ STS ~ beta ~ Choice", 8, sig_thresh = 0.01, regions = c("STS", "sts"))
beta_plots_all_subjects_choice(beta_choice_cleaned_results_35, "IR35 ~ STS ~ beta ~ Choice", 8, sig_thresh = 0.01, regions = c("STS", "sts"))
...
# By region #
beta_plots_all_subjects_choice(gamma_choice_cleaned_results_19, "IR19 ~ STS ~ gamma ~ Choice", 8, sig_thresh = 0.01, regions = c("STS", "sts"))
beta_plots_all_subjects_choice(gamma_choice_cleaned_results_35, "IR35 ~ STS ~ gamma ~ Choice", 8, sig_thresh = 0.01, regions = c("STS", "sts"))
...
# By region #
beta_plots_all_subjects_choice(hfa_choice_cleaned_results_19, "IR19 ~ HFA ~ gamma ~ Choice", 8, sig_thresh = 0.01, regions = c("STS", "sts"))
beta_plots_all_subjects_choice(hfa_choice_cleaned_results_35, "IR35 ~ HFA ~ gamma ~ Choice", 8, sig_thresh = 0.01, regions = c("STS", "sts"))
beta_plots_all_subjects_choice(hfa_choice_cleaned_results_57, "IR57 ~ HFA ~ gamma ~ Choice", 8, sig_thresh = 0.01, regions = c("STS", "sts"))


beta_plots_all_subjects_choice(hfa_choice_cleaned_results_19, "IR19 ~ HFA ~ MFG ~ Choice", 8, sig_thresh = 0.01, regions = c("MFG", "mfg"))
beta_plots_all_subjects_choice(hfa_choice_cleaned_results_35, "IR35 ~ HFA ~ MFG ~ Choice", 8, sig_thresh = 0.01, regions = c("MFG", "mfg"))
beta_plots_all_subjects_choice(hfa_choice_cleaned_results_57, "IR57 ~ HFA ~ MFG ~ Choice", 8, sig_thresh = 0.01, regions = c("MFG", "mfg"))

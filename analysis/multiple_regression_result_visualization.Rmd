...
## save for interaction analyses #
write_csv(betas_pres_mult_reg_results, path(here(), "results", "multiple_regressions", "betas_pres_mult_reg_results.csv"))
write_csv(betas_choice_mult_reg_results, path(here(), "results", "multiple_regressions", "betas_choice_mult_reg_results.csv"))

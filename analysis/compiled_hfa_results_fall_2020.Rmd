---
title: 'August 2020 EDA: Presentation ~ Power ~ Trial Types'
...
for(elec in active_all_elec_list_35) {
  ...
  if(elec %in% active_elec_list_35) {
    presentation_plot <- plots_power_envelope_by_trial_type(hg_data_35,
                                     behave_data_11,
                                     active_data_35_adv,
                                     active_data_35_dis,
                                     elec,
...
for(elec in active_all_elec_list_57) {
  ...
  if(elec %in% active_elec_list_57) {
    presentation_plot <- plots_power_envelope_by_trial_type(hg_data_57,
                                     behave_data_11,
                                     active_data_57_adv,
                                     active_data_57_dis,
                                     elec,
...
for(elec in active_all_elec_list_19) {
  ...
  if(elec %in% active_elec_list_19) {
    presentation_plot <- plots_power_envelope_by_trial_type(hg_data_19,
                                     behave_data_11,
                                     active_data_19_adv,
                                     active_data_19_dis,
                                     elec,
...
for(elec in active_all_elec_list_39) {
  ...
  if(elec %in% active_elec_list_39) {
    presentation_plot <- plots_power_envelope_by_trial_type(hg_data_39,
                                     behave_data_11,
                                     active_data_39_adv,
                                     active_data_39_dis,
                                     elec,
...
for(elec in active_all_elec_list_28) {
  ...
  if(elec %in% active_elec_list_28) {
    presentation_plot <- plots_power_envelope_by_trial_type(hg_data_28,
                                     behave_data_11,
                                     active_data_28_adv,
                                     active_data_28_dis,
                                     elec,
...
for(elec in active_all_elec_list_10) {
  ...
  if(elec %in% active_elec_list_10) {
    presentation_plot <- plots_power_envelope_by_trial_type(hg_data_10,
                                     behave_data_11,
                                     active_data_10_adv,
                                     active_data_10_dis,
                                     elec,
...
for(elec in active_all_elec_list_16) {
  ...
  if(elec %in% active_elec_list_16) {
    presentation_plot <- plots_power_envelope_by_trial_type(hg_data_16,
                                     behave_data_11,
                                     active_data_16_adv,
                                     active_data_16_dis,
                                     elec,
